...
/// <summary>
/// Computes a 16-bit CRC using the variant selected by the factory.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public sealed class Crc16Service : IChecksumService
{
    ...
    internal Crc16Service(CrcParameters parameters, int bufferSize = CryptoDefaults.StreamBufferSize)
    {
    ...
    private static byte[] ToBigEndian(uint value) => [(byte)(value >> 8), (byte)value];
}
