...
/// <summary>
/// Provides cryptographic services for stream cipher operations. Encrypts and decrypts stream data
/// with a caller-supplied key and nonce, supporting asynchronous operation with progress reporting
/// and cancellation.
/// </summary>
public interface IStreamCipherService
{
    ...
    /// <param name="nonce">A number used once that must be unique for each encryption with the same key.</param>
