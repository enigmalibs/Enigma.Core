...
| FEATURE-4442 | Abstraction skeleton (interfaces + empty impls)    | TODO   | docs/plan/FEATURE-4442.md |
| - PHASE01    | Shared foundation (root types + shared enums)      | TODO   | (in FEATURE-4442.md)      |
| - PHASE02    | Symmetric (BlockCiphers, StreamCiphers) + Padding  | TODO   | (in FEATURE-4442.md)      |
